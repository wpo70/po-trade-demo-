...
<div class="menu-modal">
    <Modal bind:open={showMenus} passiveModal modalHeading="" on:open on:close>
      <div class="wrapper">
        ...
        <Column >
          <div><button expressive size="xl" type="tertiary"  class="box-modal rba-ois-view col_third" on:click={() => {main_content = 'trading'; view = 'fxOption'; showMenus=false;}}>
